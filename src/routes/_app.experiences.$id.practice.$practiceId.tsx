...
import { ChevronLeft, Clock, Tag, Gauge, Repeat } from "lucide-react";
    ...
    <div className="mx-auto w-full max-w-[430px] px-5 pt-8 pb-6 animate-soft-in">
      ...
      <header className="mb-6 text-center">
        ...
        <p className="mx-auto mt-3 max-w-[300px] text-[13px] font-light leading-relaxed text-white/85">
          A short, grounding moment you can return to whenever you need it.
        </p>
      </header>
      ...
      <div className="mb-6 grid grid-cols-2 gap-3">
        {[
          ...
          { Icon: Tag, label: "Category", value: id.replace(/-/g, " ") },
      ...
      <section className="mb-8 rounded-[22px] border border-white/20 bg-white/10 p-4 backdrop-blur-xl">
        <h2 className="font-seasons text-[16px] text-white">Perfect When…</h2>
        <ul className="mt-2 space-y-1.5 text-[12.5px] font-light text-white/85">
          {[
            "Your thoughts feel tangled",
            "You need to slow down before something big",
            "You want a small kindness for yourself",
          ].map((t) => (
            <li key={t} className="flex gap-2">
